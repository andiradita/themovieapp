...
android {
    namespace = "com.andiradita.themovieapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.andiradita.themovieapp"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.legacy:legacy-support-v4:1.0.0") // LiveData
    kapt("androidx.lifecycle:lifecycle-compiler:2.6.1") // Annotation processor
    // login intercept
